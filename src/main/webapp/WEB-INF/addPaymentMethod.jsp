...
<body>
    <form method="POST">
        ...
        <p class="title-form">Scegli il metodo di pagamento</p>
            <div class="radio-container">
                <div class="radio-item">
                    <input id="method1" type="radio" name="choose-method" value="Carta Di Credito" onclick="showCreditCard()">
                    <label for="method1"> Carta Di Credito</label>
                    <input id="method2" type="radio" name="choose-method" value="Conto Corrente" onclick="showBankAccount()">
        ...
        <div id="credit-card">
                ...
                <div>
                    ...
                    <input type="text" placeholder="XXXX-XXXX-XXXX-XXXX" id="card-number" name="card-number" maxlength=19 required/>
                </div>
                <div>
    ...
    <script>
        ...
        const backAccount = document.getElementById("bank-account")

        const showCreditCard = () => {
            creditCard.classList.add("show-form")
            if (backAccount.classList.contains("show-form")) {
                backAccount.classList.remove("show-form")
            }
        }
        const showBankAccount = () => {
            backAccount.classList.add("show-form")
            if (creditCard.classList.contains("show-form")) {
