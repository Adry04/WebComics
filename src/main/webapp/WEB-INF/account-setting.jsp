...
<body>
    <form action="" method="POST" onsubmit="return dataValidation()">
        ...
        <p class="title-form">Impostazioni account</p>
        <div class="input-container">
            <div>
                <label for="email-input">Email</label>
                <input name="email" value="<%=session.getAttribute("email")%>" id="email-input" required placeholder="Email">
            </div>
            <div>
                <label for="nome-input">Nome</label>
                <input name="nome" value="<%=session.getAttribute("nome")%>" id="nome-input" required placeholder="Nome">
            </div>
            <div>
                <label for="cognome-input">Cognome</label>
                <input name="cognome" value="<%=session.getAttribute("cognome")%>" id="cognome-input" required placeholder="Cognome">
            </div>
            <p class="error-text <%=request.getAttribute("error") == null ? "remove-item" : ""%>" id="error-text"><%=request.getAttribute("error") != null ? request.getAttribute("error") : ""%></p>
            <button type="submit"> Salva </button>
        </div>
    </form>
    <form class="second-form" action="" method="POST" onsubmit="return passwordValidation()">
        ...
        <div class="input-container">
            ...
            <p class="error-text <%=request.getAttribute("error-password") == null ? "remove-item" : ""%>" id="error-password-text"><%=request.getAttribute("error-password") != null ? request.getAttribute("error-password") : ""%></p>
            <button type="submit"> Salva </button>
        </div>
    </form>
    <script src="js/accountSettingValidation.js"></script>
</body>
</html>