    ...
    <div class="container-page">
        <div class="top-section">
            <div class="text-top-section">
                <h1>Prodotti</h1>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><g fill="none" stroke="#000" stroke-linejoin="round" stroke-width="4"><path d="M44 14L24 4L4 14V34L24 44L44 34V14Z"></path><path stroke-linecap="round" d="M4 14L24 24"></path><path stroke-linecap="round" d="M24 44V24"></path><path stroke-linecap="round" d="M44 14L24 24"></path><path stroke-linecap="round" d="M34 9L14 19"></path></g></svg>
            </div>
